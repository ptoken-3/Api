...
4、secret_key放在组合串最后面，不参与排序


## <span id="a6">请求交互</span>

REST访问的根URL：``` https://www.ckin.info/open/api.html?action=xx ```
...
1. 接口地址: https://www.ckin.info/open/api.html?action=ex_mappings
...
1. 接口地址: https://www.ckin.info/open/api.html?action=ex_transactions
...
1. 接口地址: https://www.ckin.info/open/api.html?action=ex_market
...
1. 接口地址: https://www.ckin.info/open/api.html?action=order_depth
...
1. 接口地址: https://www.ckin.info/open/api.html?action=ex_kline
2. 接口说明: (get请求)获取对应交易对的市场深度
...
1. 接口地址: https://www.ckin.info/open/api.html?action=get_userinfo
...
1. 接口地址: https://www.ckin.info/open/api.html?action=create_orders
2. 接口说明: (get请求)创建委托单
...
1. 接口地址: https://www.ckin.info/open/api.html?action=cancel_order
2. 接口说明: (get请求)创建委托单
...
1. 接口地址: https://www.ckin.info/open/api.html?action=get_open_orders
...
1. 接口地址: https://www.ckin.info/open/api.html?action=get_order_details
...
1. 接口地址: https://www.ckin.info/open/api.html?action=get_order_history
